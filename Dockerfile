...
export YARN_CONF_DIR=$HADOOP_HOME/etc/hadoop:' $HADOOP_PREFIX/etc/hadoop/hadoop-env.sh
RUN sed -i '/^export HADOOP_CONF_DIR/ s:.*:export HADOOP_CONF_DIR=/home/$USER_NAME/hadoop-2.9.2/etc/hadoop/:' $HADOOP_PREFIX/etc/hadoop/hadoop-env.sh
